...
import GetOurLocation from '../../assets/get-our-location.png';
         ...
         
{
 ...
 const handleTileClick = (e)=>
    ...
    return(
        <section>
            <OnlyTextCover coverText={"Ask Us Anything"} coverPic={coverPic}/>

            <p className='quick-contact'>Quick Contact Info</p>  
            <hr />
            
            <section className='tile-container'></section>
                <DualTiles careerLeftTile={"WhatsApp us"} careerRightTile={"Call us"} pics={rowTwoPics} handleTileClick={handleTileClick} isLink={false}></DualTiles>
            <section className='tile-container'></section>


            <p className='quick-contact'>Write or Visit Us</p>  
            <hr />

            <section className='tile-container'>
            <TripleTiles careerLeftTile={"E-mail us"} careerMiddleTile={"Drop us a letter"} careerRightTile={"Location on Map"} pics={rowOnePics} handleTileClick={handleTileClick} isLink={false}></TripleTiles>
            </section>
